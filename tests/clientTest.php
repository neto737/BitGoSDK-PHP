...
class clientTest extends TestCase {
    ...
    public function testEnvironment(): void {
        $env = new Environment(Environments::MAINNET, '59cd72485007a239fb00282ed480da1f', Testnet::BTC);
    ...
    public function testEnvironmentInvalidWalletId(): void {
        ...
        $env = new Environment(Environments::MAINNET, 'YOUR_WALLET_ID', Testnet::BTC);
    }
